---
{"dg-publish":true,"dg-path":"5-Rules & Homebrew/House Rules/Sane Magical Prices.md","permalink":"/5-rules-and-homebrew/house-rules/sane-magical-prices/","dg-note-properties":{}}
---
...
These are standard D&D 5.5e purchase prices for nonmagical equipment. Prices are expressed in gold pieces for consistency with the rest of Sane Magical Prices.
...
Items used up through their intended use. Prices reflect practical utility rather than rarity alone.
...
| Ammunition of Slaying (each) | 600 | Very Rare |
...
| Potion of Greater Invisibility | 2,500 | Very Rare |
...
| Potion of Pugilism | 150 | Uncommon |
...
| Adamantine Weapon | 500 \+ base weapon | Uncommon |
...
| Energy Bow | 18,000 | Very Rare |
| Executioner's Axe | 12,000 \+ base weapon | Very Rare |
...
| Lute of Thunderous Thumping | 20,000 | Very Rare |
...
| Quarterstaff of the Acrobat | 20,000 | Very Rare |
| Ring of Elemental Command (Fire) | 40,000 | Legendary |
| Ring of Elemental Command (Water) | 45,000 | Legendary |
...
| Silvered Weapon | 150 \+ base weapon | Common |
...
| Vicious Weapon | 12,000 \+ base weapon | Rare |
...
| Wraps of Unarmed Power \+1 | 1,000 | Uncommon |
| Wraps of Unarmed Power \+2 | 4,000 | Rare |
| Wraps of Unarmed Power \+3 | 16,000 | Very Rare |

**Noncombat Items**

Items whose primary value is exploration, travel, information, infiltration, utility, or solving problems outside direct combat.
...
| Cloak of the Manta Ray | 4,000 | Uncommon |
| Cube of Force | 25,000 | Rare |
...
| Hag Eye | 2,000 | Uncommon |
| Hat of Disguise | 5,000 | Uncommon |
| Hat of Many Spells | 30,000 | Very Rare |
| Helm of Comprehending Languages | 500 | Uncommon |
| Helm of Telepathy | 12,000 | Uncommon |
| Heward's Handy Haversack | 2,000 | Rare |
| Horseshoes of a Zephyr | 1,500 | Very Rare |
...
| Spirit Board | 20,000 | Very Rare |
| Sylvan Talon | 250 \+ base weapon | Common |
...
Items that call or create creatures to assist the user. Their value depends heavily on how the campaign handles allied creatures and hirelings.

| Item | Price (gp) | Rarity |
| :---- | ----- | ----- |
| Baba Yaga's Dancing Broom | 1,500 | Uncommon |
| Bowl of Commanding Water Elementals | 15,000 | Rare |
| Brass Horn of Valhalla | 8,400 | Rare |
| Brazier of Commanding Fire Elementals | 15,000 | Rare |
| Bronze Horn of Valhalla | 11,200 | Very Rare |
| Censer of Controlling Air Elementals | 15,000 | Rare |
| Cube of Summoning | 12,000 | Rare |
...
| Stone of Controlling Earth Elementals | 15,000 | Rare |

**Game-Changing Items**

Items capable of reshaping how a party interacts with the world or bypassing broad categories of challenges. GM review is recommended before routine availability.
...
| Broom of Flying | 6,000 | Uncommon |
...
| Ring of Elemental Command (Air) | 45,000 | Legendary |
| Ring of Elemental Command (Earth) | 50,000 | Legendary |
...
| Shield of the Cavalier | 30,000 \+ shield | Very Rare |
| Sphere of Annihilation | 15,000 | Legendary |
| Staff of Power | 95,500 | Very Rare |
| Talisman of the Sphere | 20,000 | Legendary |
| Thunderous Greatclub | 35,000 | Very Rare |
| Winged Boots | 8,000 | Uncommon |
| Wings of Flying | 5,000 | Rare |

**Enspelled Items**

5.5e items holding a rechargeable spell. Their value scales primarily with the contained spell level, so they use a dedicated schedule rather than one flat price.

| Item | Price (gp) | Rarity |
| :---- | ----- | ----- |
| Enspelled Armor | See schedule \+ base armor | Varies |
| Enspelled Staff | See schedule (90%) | Varies |
| Enspelled Weapon | See schedule \+ base weapon | Varies |

**Enspelled Item Price Schedule**

Baseline price is determined by the contained spell level. Add the mundane armor or weapon cost where applicable. Enspelled Staff uses 90% of the listed baseline because expending its last charge can destroy the item's magic.

| Contained Spell Level | Baseline Price (gp) |
| :---- | ----- |
| Cantrip | 2,000 |
| 1 | 6,000 |
| 2 | 12,000 |
...
These items are intentionally kept outside the normal pricing system because their effects are too random, campaign-defining, powerful, or dependent on GM control to support a stable utility-based market value.

| Item | Why It Is Not Priced |
| :---- | :---- |
| Bag of Beans | Highly random effects, including campaign-scale outcomes. |
| Bag of Tricks | Creating permanent living creatures can have outsized economic effects. |
| Belt of Giant Strength | Can push ability scores beyond normal bounded-accuracy expectations. |
| Candle of Invocation | Historically difficult to price cleanly because of its unusually broad impact. |
| Cursed Items | Price individually, if they are sold at all. |
| Deck of Many Things | Too random and campaign-altering for a stable market price. |
| Efreeti Bottle | Potential access to wishes makes a stable price impractical. |
| Helm of Brilliance | Highly variable, charge-based power makes valuation inconsistent. |
| Iron Flask | Potentially captures or releases extremely powerful creatures. |
| Luck Blade | Potential access to wishes makes a stable price impractical. |
| Manual of Golems | Better treated as a blueprint; price the blueprint and crafting requirements for the campaign. |
| Manuals and Tomes (+2) | Often function more like permanent character advancement than ordinary market goods. |
| Potion of Giant Strength | Can temporarily push ability scores beyond normal bounded-accuracy expectations. |
| Ring of Djinni Summoning | Combines several campaign-changing capabilities in a single item. |
| Ring of Three Wishes | Wish access makes a stable market price impractical. |
| Rod of Resurrection | Often functions better as a plot-level resource than an ordinary market item. |
| Scroll of Titan Summoning | A hostile titan persists until defeated; this is a campaign event rather than sensible retail stock. |
| Staff of the Magi | Power level is too broad for a simple market price. |
| Tome of the Stilled Tongue | The source assumes an owner would be extremely unlikely to sell it. |
